...
public class CompactionsCQLTest extends CQLTester
{
    ...
    public void testSetLocalCompactionStrategy() throws Throwable
    {
        ...
        execute("ALTER TABLE %s WITH compaction = {'class':'LeveledCompactionStrategy'}");
        // will use the new option
        assertTrue(verifyStrategies(getCurrentColumnFamilyStore().getCompactionStrategyManager(), LeveledCompactionStrategy.class));
    }
