...
public class CustomGuardrail<VALUE> extends Guardrail
{
                           ...
                           boolean guardWhileSuperuser)
    {
        ...
        validator = new AtomicReference<>(CustomGuardrail.getValidator(name, config));
     ...
     * @throws ConfigurationException thrown in case class of a validator to instantiate was not found or validator's
