...
public class Config
{
    ...
    public volatile ObjectValuesParametrizedClass password_validator = new ObjectValuesParametrizedClass(NoOpPasswordValidator.class.getCanonicalName(), Collections.emptyMap());
